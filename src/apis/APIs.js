...
// About me api's
export const addAboutMeApiUrl = "https://portfolio-backend-gwo5.onrender.com/api/v1/aboutme"; // POST
export const updateAboutMeApiUrl = "https://portfolio-backend-gwo5.onrender.com/api/v1/aboutme"; // PATCH
export const updateTechStackApiUrl = "https://portfolio-backend-gwo5.onrender.com/api/v1/aboutme"; // PUT
...
// export const loginAdminApiUrl = "http://localhost:8080/api/v1/admins/login";

// // about me apis
// export const addAboutMeApiUrl = "http://localhost:8080/api/v1/aboutme"; // POST
// export const updateAboutMeApiUrl = "http://localhost:8080/api/v1/aboutme"; // PATCH
// export const updateTechStackApiUrl = "http://localhost:8080/api/v1/aboutme"; // PUT
// export const getAboutMeApiUrl = "http://localhost:8080/api/v1/aboutme"; // GET
